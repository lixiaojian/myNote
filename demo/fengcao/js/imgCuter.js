    /**
 * @ignore
 * Created by xiaojianli@pptv.com on 2016/3/26.
 * 图片剪切插件
 */
;(function(){
    var doc = document;
    ...
    var ImgCuter = function(opt){
        this.parentElement = opt.parentElement || doc.body;
    ...
    var initComps = function(cb){
        ...
        if(this.maxHeight){
            origImg.style.maxHeight = this.maxHeight+'px';
        }else if(this.maxHeightProportion){
            //让裁剪区域最多可为屏幕的一半
